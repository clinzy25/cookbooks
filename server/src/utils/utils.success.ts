...
import { ISuccessResponse } from '../types/@types.utils'
...
export const REQUEST_SUCCEEDED_RES: ISuccessResponse = {
  statusCode: 200,
  message: 'Your request was processed successfully',
}

export const RESOURCE_CREATED_SUCCESSFULLY = 'success/create-success'
export const RESOURCE_CREATED_SUCCESSFULLY_RES: ISuccessResponse = {
  statusCode: 201,
  message: 'Resource created successfully',
}

export const RESOURCE_UPDATED_SUCCESSFULLY = 'success/update-success'
export const RESOURCE_UPDATED_SUCCESSFULLY_RES: ISuccessResponse = {
  statusCode: 204,
  message: 'Resource updated successfully',
}

export const RESOURCE_DELETED_SUCCESSFULLY = 'success/delete-success'
export const RESOURCE_DELETED_SUCCESSFULLY_RES: ISuccessResponse = {
  statusCode: 200,
